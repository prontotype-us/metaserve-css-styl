...
(function() {
  var VERBOSE, de_res, fs, rework_calc, rework_color, rework_colors, rework_function, rework_import, rework_inherit, rework_variant, styl;
  ...
  module.exports = {
    ...
    compile: function(filename, config, context, cb) {
      ...
      transformer = function(sass_src) {
        return styl(pre_transformer(sass_src)).use(rework_inherit()).use(variant).use(rework_calc).use(rework_colors()).use(rework_color).use(rework_function(config.functions || {})).toString();
      };
