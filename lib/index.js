...
(function() {
  var Compiler, StylCompiler, de_res, fs, rework_calc, rework_color, rework_colors, rework_function, rework_import, rework_inherit, rework_shade, rework_variant, styl,
  ...
  StylCompiler = (function(superClass) {
    ...
    StylCompiler.prototype.compile = function(sass_filename, cb) {
      var compiled, options, pre_transformer, source, transformer, variant;
      ...
      transformer = function(sass_src) {
        return styl(pre_transformer(sass_src)).use(rework_inherit()).use(variant).use(rework_calc).use(rework_colors()).use(rework_color).use(rework_function(options.functions || {})).toString();
      };
